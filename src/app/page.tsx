...
export default function Home() {
  return (
    <div className="min-h-screen home-page-gradient">
      <ThemeToggle />
      <div className="max-w-4xl mx-auto p-8">
        ...
        {/* Feature comparison */}
        <div className="mt-12 home-card-gradient border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Next.js App Router</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">TypeScript</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300">
